...
* Efter webbdomän: visar de domäner (högnivådomäner som är registrerade hos registratorerna) som finns i URL:erna för länkarna och bilderna i spaminnehållet. I Adobe-lösningar är den domän som ska beaktas vanligtvis den adress som används för spårning.
